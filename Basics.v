...
Example test_bin_incr3 : incr (A Z) = B Z. 
Proof. reflexivity. Qed. 

Example test_bin_incr4 : incr (A (A (A (B Z)))) = B (A (A (B Z))). 
Proof. reflexivity. Qed. 
...
Example test_bin_to_nat3 : bin_to_nat (A Z) = 0. 
Proof. reflexivity. Qed. 

Example test_bin_to_nat4 : bin_to_nat (A (A (A (B Z)))) = 8. 
Proof. reflexivity. Qed. 

Example test_bin_to_nat5 : bin_to_nat Z = 0. 
Proof. reflexivity. Qed. 
